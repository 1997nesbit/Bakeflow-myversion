...
import type { Order, OrderStatus, NewOrderData, OrderSummary, OrderTrackingResponse } from '@/types/order'
...
export const ordersService = {
  ...
  getByTrackingId: async (trackingId: string): Promise<OrderTrackingResponse> => {
    return (await apiClient.get<OrderTrackingResponse>(`/orders/track/${trackingId}/`)).data
  },
