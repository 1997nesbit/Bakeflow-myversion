                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xs text-amber-700">Balance TZS {Math.ceil(paymentOrder.totalPrice / 2).toLocaleString()} on pickup day</p>
                        </div>
                        <p className="text-xl font-bold text-amber-800">TZS {Math.ceil(paymentOrder.totalPrice / 2).toLocaleString()}</p>
                      </div>
                    </button>
                  )}
                </div>
