...
import { PackageCheck, Clock, Calendar, MapPin, ArrowRight, CheckCircle, Truck } from 'lucide-react'
      ...
      <main className="ml-64 p-6">
        ...
        <div className="mb-6 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              {orders.filter(o => o.status === 'packing').length} orders awaiting packing
            </p>
          </div>
        </div>
        ...
        {showCompleted && (
          <div className="fixed bottom-6 right-6 z-50 flex items-center gap-2 rounded-lg bg-green-600 px-4 py-3 text-white shadow-lg">
            ...
            <span>Order marked ready - sent to Driver Portal!</span>
          </div>
        )}
      </main>
    </div>
