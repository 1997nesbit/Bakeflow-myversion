...
import { mockBusinessExpenses, businessExpenseCategories, type BusinessExpense, type BusinessExpenseCategory, type PaymentMethod, paymentMethodLabels } from '@/lib/mock-data'
